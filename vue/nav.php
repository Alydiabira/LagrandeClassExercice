        ...
        <nav class="navbar fixed-top " style="background-color:#014507; color: white;">
            <div class="container-fluid">
                ...
                <ul class="nav justify-content-center">
                    <li class="nav-item border-radius: 2px;" <?php if (isset($_SESSION['PROFILE'])) { ?>>
                      <a class="nav-link   " aria-current="page" href="home.php"  tabindex="0" >Accueil</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="editEtudiant.php">editEtudiant</a>
                    </li>
                    <li class="nav-item">
