...
<body onmouseenter="myEnterFunction1()">
<!--nav-->
<head>
    <meta charset="UTF-8">
...
<!--nav--><!--nav-->
            ...
            <div id="mobile-box">
                ...
                <div class="card">
                    <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                        <img class="card-img-top" src="../img/aly.jpg" alt="Card image cap" style="border-radius: 1rem 0 0
                                            1rem; height: 450px; width: 450px;">
                        <a href="#!">
                            <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                        </a>
                    </div>
                    <div class="card-body text-center">
                        <h5 class="h5 font-weight-bold"></h5>
                        <p class="mb-3">Récitation</p>
                        <audio controls>
    ...
    <section>
        <div class="ratio ratio-16x9">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/hTKT0KaWI_4"
