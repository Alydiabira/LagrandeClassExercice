...
<!--nav-->
    ...
    <div class="overflow-x-auto">
        <h1 class="text-center">
            <a href="https:&#x2F;&#x2F;www.canva.com&#x2F;design&#x2F;DAFOjetyUY0&#x2F;view?utm_content=DAFOjetyUY0&amp;utm_campaign=designshare&amp;utm_medium=embeds&amp;utm_source=link" target="_blank" rel="noopener">
              Mémorisation</a> de Aly DIABIRA
        </h1>
    </div>
    <div id="carouselExampleIndicators" class="carousel slide">
        ...
        <button class="carousel-control-prev " onclick="compteur()" title="Nombre de lectures quotidiennes." style="background-color: #01450741;">
            <p class="text-white" style="font-size:xx-large;"><b class="ch">سورة النساء</b></p> 
            <span class="position-absolute top-3 start-50 translate-middle">
                <p id='nb' style="font-size:xx-large; background-color:#014507;"  class="badge" onmousedown="mDown(this)"><b>
                <svg xmlns="http://www.w3.org/2000/svg" width="100" height="40" fill="currentColor" class="bi bi-play-fill" viewBox="0 0 16 16">
                    <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z"/>
                </svg>
                </b>Continue in sha ALLAH</p>
            </span>
        </button>
        ...
        <div class="carousel-indicators">
            <ul class="list-group list-group-numbered">
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    ...
                    <div class="fw-bold" style="font-family: 'Bangers', cursive;">Répétition totale : </div>
                    </div>
                    <span  class="badge rounded-pill" id='bn' style="background-color: #8c52ff;"> Continue </span>
        ...
        <!-- <section>
            <div class="container text-center">
                <div class="row align-items-center overflow-x-auto">
                    <div class="col">
                        <span>
                            سورة النساء
                        </span>
                    ...
                    <div class="col">
                        <p style="font-size:xx-large; background-color: #8c52ff  " onclick="compteur()">
                             Répétition totale  =
                            <span class="position-absolute top-0 start-100 translate-middle " >
                                <p  style="font-size:xx-large; background-color: #8c52ff ;"  class="badge" id='nb'><b> 425 </b>fois</p>
                            </span>
                        </p>
                    </div>
                    <div class="col">
